    ...
    <div class="slide-1 home-slider">
        <div>
            <a href="" class="home text-center">
                <img src="<?= addslashes($this->_dirImg)?>slider.jpg" alt="" class="bg-img blur-up lazyload">
            </a>
        </div>
                ...
                <div class="product-4 product-m no-arrow">
                    <div class="product-box">
                        <div class="img-wrapper">
                            ...
                            <div class="front">
                                <a href="item.html">
                                    <img src="<?= addslashes($this->_dirImg)?>product.jpg" class="img-fluid blur-up lazyload bg-img" alt="product">
                                </a>
                            </div>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-lg-6 col-xs-12">
                        <div class="quick-view-img"><img src="<?= addslashes($this->_dirImg)?>quick-view-bg.jpg" alt="" class="w-100 img-fluid blur-up lazyload book-picture"></div>
                    </div>
