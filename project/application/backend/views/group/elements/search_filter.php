...
$selectBox_GroupACP = HelperBackend::selectBox('filter_group_acp', 'filter_group_acp', $arrOptions, @$this->arrParam['filter_group_acp']);
?>
...
<div class="card card-info card-outline">
    ...
    <div class="card-body">
        <div class="row justify-content-between">
            ...
            <div class="mb-1">
                <form action="" method="get" id="form_group_acp">
